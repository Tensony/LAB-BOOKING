      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map(lab => (
            ...
            >
              <LabImage src={lab.image_url} name={lab.name} className="w-full h-36" />
              <div className="p-5">
                ...
                <div className="flex items-center text-brand-600 text-sm font-medium gap-1 group-hover:gap-2 transition-all">
